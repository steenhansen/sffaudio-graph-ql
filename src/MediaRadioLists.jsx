...
function MediaRadioLists(props) {
    ...
    function rsdTransformFunc(a_media) {
        ...
        var post_html = <a href={rsd_post}> #{rsd_episode} {rsd_description} </a>;
        return post_html;
    }
    ...
    function pdfTransformFunc(a_media) {
        ...
        var post_html = <span><a href={pdf_url}> {book_title} </a>{published_by_by}</span>;
        return post_html;
    }
    ...
    function podcastTransformFunc(a_media) {
        ...
        var post_html = <span> {podcast_mess} <a href={sffaudio_post}> #{rsd_episode} {rsd_description} </a> </span>;
        return post_html;
    }
    ...
    function postTransformFunc(a_media) {
        ...
        var post_html = <a href={page_post}> {page_headline}</a>;
        return post_html;
    }
    ...
    function liTransformFunc(media_string, index) {
        var rsd = <li key={"li_index_" + index}>{media_string.media_html} </li>;
        return rsd;
    }
    ...
    function pdfIssues(one_media_list) {
        ...
        one_media_list.map(function (a_pdf) {
            ...
            a_pdf.issues.map(function (an_issue) {
                ...
                var new_pdf = {author: author, title: title, url: url, publisher: publisher, pages: pages};
